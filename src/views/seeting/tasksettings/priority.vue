...
<div class="main-container">
        ...
        <div class="container">
            <div class="container-flexbox">
                ...
                <div class="main-container-body">
                    ...
                    <el-table-column prop="ProjectCategoryIdName" sortable label="图标" width="100"></el-table-column>
                    <el-table-column prop="ProjectCategoryIdName" sortable label="颜色" width="100"></el-table-column>
                    <el-table-column
                        label="操作"
                        width="100">
        ...
        <newpriority v-model="dialogFormVisible" :itemid="itemid"></newpriority>
    </div>
</template>
<script>
...
import newpriority from '@/alert/newpriority.vue'
export default {
  data() {
    return {
  ...
  components:{
        Userhead,checkboxdrop,commontable,selectdrop,newpriority
  },
  created(){
